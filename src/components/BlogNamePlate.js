	...
	return (
		<>
			...
			<style jsx>{`
				...
				.plate .right-side .dateOfBlog {
					color: red;
				}

				/* ////////////////////// fun with hourglass starts here*/
				...
				@keyframes hourglass {
					0% {
						...
						box-shadow: inset var(--brand-orange) 0 0em 0 0,
							inset var(--site-bg-color) 0 2em 0 0,
							inset var(--brand-orange) 0 4em 0 0;
					}
					80% {
						transform: rotate(0deg);
						box-shadow: inset var(--brand-orange) 0 2em 0 0,
							inset var(--site-bg-color) 0 2em 0 0,
							inset var(--brand-orange) 0 2em 0 0;
					}
					100% {
						transform: rotate(180deg);
						box-shadow: inset var(--site-bg-color) 0 2em 0 0,
							inset var(--brand-orange) 0 2em 0 0,
							inset var(--site-bg-color) 0 2em 0 0;
					}
				}
